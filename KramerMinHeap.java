...
public class KramerMinHeap <T extends Comparable> {
    ArrayList <T> arr = new ArrayList<T>();
    ArrayList<theNode> vals = new ArrayList<theNode>();
...
//    void insert(int nodeNum, int tdist) {
//    	theNode insertNode = new theNode();
//    	insertNode.num = nodeNum;
//    	insertNode.tdis = tdist;
//    	vals.add(insertNode);
//    	
//    }
